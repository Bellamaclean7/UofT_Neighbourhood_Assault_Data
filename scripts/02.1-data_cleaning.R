...
surrounding_neighbourhoods <- assault_rate_data |>
  filter(Neighbourhood %in% c("Palmerston-Little Italy", "Trinity Bellwoods", "West Queen West", "Wellington Place", "Bay-Cloverhill", "Yonge-Bay Corridor", "Wychwood", "Casa Loma", "Yonge-St.Clair"))
