#### Preamble ####
# Purpose: Cleans the raw data to create outputs/data/discussion_data.csv
...
all_neighbourhoods <- assault_rate_data |>
  filter(Neighbourhood %in% c("Kensington-Chinatown", "University", "Bay-Cloverhill", "Annex", "Dovercourt Village",  "Church-Wellesley", "Palmerston-Little Italy", "Trinity-Bellwoods", "West Queen West", "Wellington Place", "Wychwood", "Casa Loma", "Yonge-St.Clair"))
...
write_csv(
  x = all_neighbourhoods,
  file = "outputs/data/discussion_data.csv"
)
